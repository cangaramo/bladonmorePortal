...
wp_register_script('popper-js', get_template_directory_uri() . '/assets/bootstrap/popper.min.js', array('jquery'));
wp_register_script('bootstrap-js', get_template_directory_uri() . '/assets/bootstrap/bootstrap.min.js', array('jquery'));
