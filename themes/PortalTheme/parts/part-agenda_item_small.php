            ...
            <div class="col-11 p-0">
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-lg-3 p-0">
                        <div class="h-100 d-flex align-items-center">
                            ...
                            if($date_session < $date_now):?>
                                <i class="d-block d-lg-none mt-1 completed fas fa-check"></i>
                                <p class="mt-2 completed">Completed</p>
                            <?php else : ?>
                                <i class="d-block d-lg-none mt-1 completed far fa-calendar-alt"></i>
                                <p class="mt-2 completed">Scheduled</p>
                            <?php endif; ?>
                    ...
                    <div class="col-12 p-0">
                        <p class="mt-1"><i class="fas fa-user-friends"></i>
